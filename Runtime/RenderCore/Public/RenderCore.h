...
DECLARE_CYCLE_STAT_EXTERN(TEXT("Update CPU Skin UE Vectorization"), STAT_CPUSKinUEVectorization, STATGROUP_SceneUpdate, RENDERCORE_API);
DECLARE_CYCLE_STAT_EXTERN(TEXT("Update CPU Skin ISPC Vectorization"), STAT_CPUSKinISPCVectorization, STATGROUP_SceneUpdate, RENDERCORE_API);
...
DECLARE_CYCLE_STAT_EXTERN(TEXT("UpdatePrimitiveInstanceFromCompute (GT)"), STAT_UpdatePrimitiveInstanceFromComputeGT, STATGROUP_SceneUpdate, RENDERCORE_API);
